...
public class EimorHelmetTickEventProcedure extends EirodeModElements.ModElement {
	public EimorHelmetTickEventProcedure(EirodeModElements instance) {
		super(instance, 8);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				EirodeMod.LOGGER.warn("Failed to load dependency entity for procedure EimorHelmetTickEvent!");
			return;
		}
