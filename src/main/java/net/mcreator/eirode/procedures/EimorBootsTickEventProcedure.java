...
public class EimorBootsTickEventProcedure extends EirodeModElements.ModElement {
	public EimorBootsTickEventProcedure(EirodeModElements instance) {
		super(instance, 5);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				EirodeMod.LOGGER.warn("Failed to load dependency entity for procedure EimorBootsTickEvent!");
			return;
		}
